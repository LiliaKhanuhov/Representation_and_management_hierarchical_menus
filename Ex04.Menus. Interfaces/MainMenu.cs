namespace Ex04.Menus.Interfaces
{
    ...
    public class MainMenu : MenuItem
    {
        ...
        private MenuItem m_PreviousMenuOption           = null;
        ...
        public MainMenu(string i_MenuTitle, string i_MenuMessage)
        {
            ...
            this.m_PreviousMenuOption = new ExitOperation("Exit");
        }
        ...
        public void setPreviousMenu(MenuItem i_PreviousMenu)
        {
        ...
        public void Show()
        {
            ...
            if (selectedOption == k_ExitOption)
            {
                ...
                if (this.m_PreviousMenuOption is ExitOperation)
                {
                    this.m_PreviousMenuOption.ExecuteOption();
                    return;
                }
                else
                {
